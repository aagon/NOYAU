...
Les index 0, 1 et 2 sont les index de la table des i

la table des ouvertures de fichier par le processus. 0, 1 et 2 sont respectivement réservés à l'entrée standard, la sortie standard et la sortie d'erreur.

*** La structure file

En plus de la table des ouvertures de fichier du processus
